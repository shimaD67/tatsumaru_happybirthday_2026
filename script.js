...
const WORD_DATA = {
    easy: [
        ...
        { ja: "ランチ", kana: "らんち" },
        { ja: "烏丸", kana: "からすま" },
        { ja: "24歳", kana: "にじゅうよんさい" },
    ],
    medium: [
        { ja: "達丸誕生日おめでとう", kana: "たつまるたんじょうびおめでとう" },
        { ja: "24歳", kana: "にじゅうよんさい" },
        { ja: "自家製生チョコ", kana: "じかせいなまちょこ" },
        ...
        { ja: "牛ハラミのグリル", kana: "ぎゅうはらみのぐりる" },
        { ja: "アヒージョ", kana: "あひーじょ" },
        { ja: "メキシカンサワー", kana: "めきしかんさわー" },
        { ja: "ワインカクテル", kana: "わいんかくてる" },
        { ja: "マスカラスブラック", kana: "ますからすぶらっく" },
        { ja: "マスカラスピカンテ", kana: "ますからすぴかんて" },
        { ja: "マスカラスオリジナル", kana: "ますからすおりじなる" },
        { ja: "COSTAポテト", kana: "こすたぽてと" },
    ],
    hard: [
        { ja: "達丸誕生日おめでとう", kana: "たつまるたんじょうびおめでとう" },
        { ja: "奈須葵心", kana: "なすきしん" },
        ...
        { ja: "てぃしかに", kana: "てぃしかに" },
        { ja: "牛ハラミのグリル", kana: "ぎゅうはらみのぐりる" },
        { ja: "奈須葵心京都で就職", kana: "なすきしんきょうとでしゅうしょく" },
        { ja: "木屋町バニーガールで散財", kana: "きやまちばにーがーるでさんざい" },
        { ja: "マスカラスブラック", kana: "ますからすぶらっく" },
        { ja: "マスカラスピカンテ", kana: "ますからすぴかんて" },
        { ja: "マスカラスオリジナル", kana: "ますからすおりじなる" },
        { ja: "太輝食ったとき腹出すぎ", kana: "だいきくったときはらですぎ" },
        { ja: "達丸早くキッチン広いとこ引っ越せ", kana: "たつまるはやくきっちんひろいとこひっこせ" },
        { ja: "工繊生御用達のメキシカン", kana: "こうせんせいごようたしのめきしかん" },
        { ja: "一乗寺のラーメン激戦区", kana: "いちじょうじのらーめんげきせんく" },
        { ja: "松ヶ崎から歩いてすぐのコスタ", kana: "まつがさきからあるいてすぐのこすた" },
        { ja: "俺もポルケッタ食いたかった", kana: "おれもぽるけったくいたかった" },
        { ja: "赤マスカラス青マスカラス黄マスカラス", kana: "あかますからすあおますからすきますからす" },
        { ja: "辛さの向こう側", kana: "からさのむこうがわ" },
        { ja: "旨辛ホットソースマスカラス", kana: "うまからほっとそーすますからす" },
        { ja: "地下鉄烏丸御池徒歩2分", kana: "ちかてつからすまおいけとほにふん" },
        { ja: "サルサ＆ワカモレチップス", kana: "さるさあんどわかもれちっぷす" },
        { ja: "スペシャルナチョス", kana: "すぺしゃるなちょす" },
        { ja: "COSTAポテト", kana: "こすたぽてと" },
        { ja: "マッシュルームのアヒージョ", kana: "まっしゅるーむのあひーじょ" },
        { ja: "ブロッコリー アリオリソース", kana: "ぶろっこりーありおりそーす" },
    ]
};
